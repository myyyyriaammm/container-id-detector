...
# save visual for the unrotated crop specifically
result_vis = stage3.predict(crop, conf=0.1, verbose=False)
cv2.imwrite("stage3_vert_lowconf.jpg", result_vis[0].plot())
